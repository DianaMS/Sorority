  ...
  <>
    <div className='contenedor_screenChat'>
      ...
      <div className='contenedorOneChat'>
        ...
        <Chat2 photoProfile2={doctora} name2='Dra. Rosa Rojas' lastMessage2='¡Hola Juana! Por supuesto, ¿cómo podría apoyarte?' />
        ...
        <Chat2 photoProfile2={doctora} name2='Dra. Rosa Rojas' lastMessage2='Así es, si deseas podemos coordinar una evaluación y ver si es posible, te gustaría?' />
        <Chat1 photoProfile1={perfil} name1='Juana María' lastMessage1='Sí por favor, podría este martes a las 4pm por videollamada?' />
        <Chat2 photoProfile2={doctora} name2='Dra. Rosa Rojas' lastMessage2='Sí! Listo :) Quedamos en contacto, un abrazo.' />
        <Answer />
      </div>
    </div>
    <NavigatorNav />
